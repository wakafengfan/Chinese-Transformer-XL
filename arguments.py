...
def add_model_config_args(parser):
    ...
    group.add_argument('--transformer-xl', default=True, help='use transformer-xl for training')
    ...
    group.add_argument('--hidden-size', type=int, default=2560,
                       help='tansformer hidden size')
    ...
    group.add_argument('--num-layers', type=int, default=32,
                       help='num decoder layers')
...
def add_training_args(parser):
    ...
    group.add_argument('--load', type=str, default="./txl-2.9B",
...
def add_text_generate_args(parser):
    ...
    group.add_argument("--out-seq-length", type=int, default=16)
